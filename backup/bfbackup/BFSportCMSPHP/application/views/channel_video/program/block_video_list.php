                ...
                <div class="row">
                    <div class="col-md-12" id="user-list">
                        <div class="box">
                            <div class="box-body">
                                <div class="col-md-12">
                                    <a class="btn btn-lg btn-flat btn-success" href="<?=base_url('ChannelVideo/addProgramToBlock/'.$block['id'])?>" role="button"><i class="fa fa-plus"></i> 添加节目</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-flat btn-warning btn-xs" role="button" href="<?=base_url('/ChannelVideo/editProgramFromBlock/'.$item['id'])?>"><i class="fa fa-edit"></i> 编辑</a>
...
<script>
$.fn.editable.defaults.url = '<?=base_url("/ChannelVideo/updateField/tmpl_program_content")?>';
...
$("input[name='visible']").bootstrapSwitch({
    ...
    onSwitchChange: function (event, state) {
        $.ajax({
            method: "POST",
            url: '<?=base_url("/ChannelVideo/updateField/tmpl_program_content")?>',
...
$('.btn-remove').on('click',function(){
    ...
    swal(alertConfig,function(){
        $.get('<?=base_url("/ChannelVideo/remove")?>/tmpl_program_content/' + vid,function(d){
            if(d == 'success'){
