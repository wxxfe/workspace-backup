...
var ReplyListComp = React.createClass({
    render: function () {
        ...
        var list = this.props.data.map(function (item, index) {
            return <ReplyComp data={item} liked={Utils.getLiked()} end={Boolean(end === index)}/>;
        });
        ...
        return (
            <div style={boxStyle}>
                <div style={StylesReply.row1}>
                    ...
                    <span
                        style={[
                            StylesReply.time, StylesReply.left1, StylesReply.top1, StylesReply.font1
                        ]}>{timeTxt}</span>
                ...
                <div style={StylesReply.row2}>
                    <button disabled={Boolean(this.state.liked)} style={StylesReply.like1} onClick={this.likeHandler}>
