                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input data-bvalidator="checkPosition,required" data-bvalidator-msg="请输入3或4" class="form-control" type="text" name="position" placeholder="可填写3或4" value="<?php if (isset($info)){echo $info['position'];} ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script>
    ...
    bValidator.validators.checkData = function (value) {
        ...
        $.ajax({
            url: '<?=base_url("app/hotspot/checkContent");?>',
    ...
    //check position
    bValidator.validators.checkPosition = function (value) {
