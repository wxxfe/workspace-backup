                ...
                <div class="col-md-12 user-list">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">社区达人类型管理</h3>
                            <a style="margin-left: 900px;" class="btn btn-success btn-flat" role="button" href="<?=base_url('/CommunityPeople/typeEdit')?>"><i class="fa fa-plus"></i> 添加类型</a>
                        </div>
                        <div class="box-body">
                            <table class="table table-hover">
                                ...
                                <?php $o = $offset; ?>
                                <?php
                                foreach($allCpType as $key => $val): $o++; ?>
                                    <tr>
                                        <td><?=$o?></td>
                                        <td><?=$val['id']?></td>
                                        <td><?=$val['name']?></td>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-flat btn-warning btn-xs" role="button" href="<?=base_url('/CommunityPeople/typeEdit?cp_id='.$val['id'])?>"><i class="fa fa-edit"></i> 更改达人类型</a>
                                            <a class="btn btn-flat btn-danger btn-xs btn-remove" role="button" href="javascript:void(0);" data-nid="<?=$val['id']?>"><i class="fa fa-remove"></i> 删除达人类型</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
...
<script>
    ...
    $('#batch-remove,.btn-remove').on('click',function(){
        ...
        swal(alertConfig,function(){
            $.post('<?=base_url("/CommunityPeople/typeRemove")?>',{id : slideId},function(d){
                if(d == 'success'){
