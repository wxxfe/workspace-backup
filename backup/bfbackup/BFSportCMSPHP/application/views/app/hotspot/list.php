                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="col-md-9 text-right">
                                <a class="btn btn-success btn-flat" role="button" href="<?=base_url('/app/hotspot/add')?>"><i class="fa fa-plus"></i> 添加</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-hover">
                                ...
                                foreach($list as $key => $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-flat btn-warning btn-xs" role="button" href="<?=base_url('/app/hotspot/add?id='.$row['id']).'&redirect='.current_url();?>"><i class="fa fa-edit"></i> 编辑</a>
...
<script>
    ...
    $('#batch-remove,.btn-remove').on('click',function(){
        ...
        swal(alertConfig,function(){
            $.post('<?=base_url("/app/hotspot/remove")?>',{id : slideId},function(d){
                if(d == 'success'){
    ...
    $("input[name='visible']").bootstrapSwitch({
        ...
        onSwitchChange: function (event, state) {
            $.ajax({
                method: "POST",
                url: "<?=base_url('/app/hotspot/upstatus') ?>",
