module.exports = function (grunt) {
    ...
    //静态资源地址
    var staticPath = 'http://static.sports.baofeng.com/olympic/pc/';
    //环境
    ...
    function getConfig(environment, username) {
        ...
        return {
            ...
            rev: {
                ...
                assets: {
                    src: [
                        'dist/' + environment + '/scripts/**/*.js',
                        '!dist/' + environment + '/scripts/lib/jquery.min.js', 'dist/' + environment + '/css/*.css'
                    ]
                }
                        ...
                        patterns: [
                            {
                                ...
                                replacement: function () {
                                    return 'http://static.sports.baofeng.com/olympic/pc/' + environment + '/player/';
            ...
            less: {
                production: {
                    files: [
                        ...
                        {'src/css/olympic-subject.css': 'src/less/olympic-subject.less'},
                        {'src/css/my-olympic.css': 'src/less/my-olympic.less'},
                        {'src/css/articles-list.css': 'src/less/articles-list.less'},
                        {'src/css/article-content.css': 'src/less/article-content.less'},
                        {'src/css/video-content.css': 'src/less/video-content.less'},
                        {'src/css/rio-seamless.css': 'src/less/rio-seamless.less'},
                        {'src/css/video-iframe.css': 'src/less/video-iframe.less'},
                        {'src/css/picture-slider.css': 'src/less/picture-slider.less'},
    ...
    grunt.registerTask('release', function (evn, username) {
        ...
        grunt.task.run([
            'clean:dist', 'requirejs', 'replace', 'clean:scripts', 'less', 'concat', 'copy', 'usemin', 'usebanner',
            'exec'
        ]);
