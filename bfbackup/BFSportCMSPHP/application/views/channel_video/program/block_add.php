                            ...
                            <div class="box-body">
                                <form class="form-horizontal" method="post" id="add-content">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input id="ref-id" type="text" class="form-control" name="program_id" placeholder="请输入节目ID" />
                                        </div>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group">
                                        <label for="title" class="col-sm-2 control-label">节目标题</label>
                                        <div class="col-sm-5">
                                            <input id="title" type="text" class="form-control" name="title" placeholder="请输入节目标题" />
                                        </div>
                                        <div class="col-sm-5">
                                            <span style="color: #f90; line-height: 30px;"><i class="fa fa-info"></i> 提示：</span>
                                            不填表示使用该视频或合集的标题
