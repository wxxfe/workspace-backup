...
define(
    ['components/not_found_error/Asset', 'components/not_found_error/Football', 'components/not_found_error/Hero', 'components/not_found_error/Enemy'],
    ...
    function (Asset, Football, Hero, Enemy) {
        ...
        var game = {
            ...
            initStage: function () {
                var container = document.getElementById('notFoundErrorGame');
                container.innerHTML = '';
