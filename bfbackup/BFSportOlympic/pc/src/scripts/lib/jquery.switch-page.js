...
(function ($) {
    var defaults = {
        ...
        'direction': 'horizontal', // 页面切换方向 horizontal, vertical
        'switchCallback': null
    };
    ...
    function scrollPage(element) {
        ...
        if (opts.switchCallback) opts.switchCallback(element);
    }
    ...
    function initEffects(dest, element) {
        ...
        if ((browser.isChrome || browser.isSafari || browser.IE || browser.Edge) && isSupportCss(transform) && isSupportCss(transition)) {
            var translate = '';
            if (opts.direction == 'horizontal') {
