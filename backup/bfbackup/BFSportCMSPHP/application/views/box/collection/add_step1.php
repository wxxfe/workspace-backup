    ...
    <div class="wrapper">
        <div class="content-wrapper" style="margin-left: 0;">
            <section class="content-header">
              <h1>添加专用合集<small>add collection</small></h1>
              <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">添加专用合集</li>
              </ol>
            </section>
                    ...
                    <div class="col-md-12" id="pending-video-list">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title text-red">[添加合集]</h3>
                            </div><!-- /.box-header -->
...
$('#fileupload2').fileupload({
    add: function (e, data) {
        ...
        if(result !== 10000){
            ...
            $("#image-view-2").html('<img src="http://image.sports.baofeng.com/' + data.result.data.pid + '" style="width:150px;">')
