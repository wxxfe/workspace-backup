    ...
    <div class="wrapper">
        <div class="content-wrapper" style="margin-left: 0;">
            <section class="content-header">
              <h1><?php if (isset($id) && $id) { echo '编辑';} else { echo '添加'; } ?>焦点图<small><?php if (isset($id) && $id) { echo 'Edit';} else { echo 'Create'; } ?> Slide </small></h1>
              <ol class="breadcrumb">
                <li><a href="/main/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active"><?php if (isset($id) && $id) { echo '编辑';} else { echo '添加'; } ?>焦点图</li>
              </ol>
            </section>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3 bvalidator-bs3form-msg">
                                                    <?php $types = array('news'=>'新闻', 'video'=>'视频', 'collection'=>'合集', 'program'=>'节目', 'gallery'=>'图集', 'special'=>'专题', 'matchteam'=>'团队对阵式比赛', 'matchplayer'=>'个人对阵式比赛', 'matchvarious'=>'非对阵式比赛', 'html'=>'URL'); ?>
                                                    <select data-bvalidator-msg="请选择焦点图来源!" required="" name="type" class="form-control">
                                                        <option value="">请选择</option>
                                                        <?php foreach ($types as $k=>$v) { ?>
                                                        <option value="<?=$k ?>" <?php if (isset($slide_info) && $slide_info && $slide_info['type'] == $k) { echo "selected"; }?>><?=$v ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input required class="form-control" type="text" name="data" value="<?php if (isset($slide_info) && $slide_info) { if($slide_info['type'] == 'html') { echo $slide_info['data']; } else {echo $slide_info['ref_id'];} } ?>" placeholder="请输入id/url" maxlength="128" data-bvalidator-msg="请输入id/url!" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input required class="form-control" type="text" name="title" value="<?php if (isset($slide_info) && $slide_info) { echo $slide_info['title'];} ?>" placeholder="请输入标题" maxlength="128" data-bvalidator-msg="请输入标题!" />
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <span style="margin-left:30px;">建议尺寸622*350</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="text" name="priority"  placeholder="" value="<?php if (isset($slide_info)) { echo $slide_info['priority'];} else { echo 1;}  ?>" />
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <?php endif;?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="checkbox">
                                                        <label><input type="checkbox" name="visible" value="1"  <?php if (!isset($id) || isset($slide_info) && $slide_info['visible'] ) { echo 'checked="checked"';} ?>></label>
                                                    </div>
                                                </div>
                                            </div>
                                          </div>
