    ...
    <div class="wrapper">
        <div class="content-wrapper" style="margin-left: 0;">
            <section class="content-header">
              <h1>编辑专用合集<small>edit collection</small></h1>
              <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                <li class="active">编辑专用合集</li>
              </ol>
            </section>
                    ...
                    <div class="col-md-12" id="pending-video-list">
                        ...
                        <div class="box box-primary no-margin">
                            <div class="box-header with-border">
                                <div class="col-md-6">
                                    <h3 class="box-title text-red">[编辑合集]</h3>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a class="btn btn-default btn-flat" role="button" href="<?=$redirect;?>"><i class="fa fa-reply"></i> 返回合集列表</a>
                                </div>
                            </div><!-- /.box-header -->
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="cover_image" class="control-label col-md-2">封面图片</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label for="large_image" class="control-label col-md-2">封面大图</label>
                                        <div class="col-md-8">
                ...
                <div class="row" style="margin-top: 15px;">
                    <div class="col-md-12" id="user-list">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <div class="col-md-6">
                                    <h3 class="box-title text-red">[添加视频]</h3>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a class="btn btn-default btn-flat" role="button" href="<?php echo site_url('/box/collection/videoSearch/').$info['id']."/video"?>"><i class="fa fa-edit"></i> 添加视频</a>
                                    <div>
...
$.fn.editable.defaults.url = '<?=base_url("/box/collection/updateSort")?>';
...
$('.btn-remove').on('click',function(){
    ...
    swal(alertConfig,function(){
        $.get('<?=base_url("/box/collection/removeVideo")?>/' + cid + '/' + vid,function(d){
            if(d == 'success'){
