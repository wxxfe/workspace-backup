                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select id="type" name="type" class="form-control">
                                                <option<?php if($content['type'] == 'video'): ?> selected="selected"<?php endif; ?> value="video">视频</option>
                                                <option<?php if($content['type'] == 'collection'): ?> selected="selected"<?php endif; ?> value="collection">合集</option>
                                                <option<?php if($content['type'] == 'program'): ?> selected="selected"<?php endif; ?> value="program">节目</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input id="ref-id" type="text" class="form-control" value="<?=$content['ref_id']?>" name="ref_id" placeholder="请输入内容ID" />
                                        </div>
                                        <div class="col-sm-7">
