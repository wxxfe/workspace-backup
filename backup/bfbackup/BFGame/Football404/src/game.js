(function () {
    ...
    game = window.game = {
        ...
        initStage: function () {
            ...
            this.enemyView = new game.Enemy({id: 'enemyView', visible: false}).addTo(this.stage);
            this.heroView = new game.Hero({id: 'heroView', visible: false}).addTo(this.stage);
        ...
        keyupHandle: function (e) {
            if ((e.keyCode === 37 || e.keyCode === 39) && this.state === 'playing') {
        ...
        initScenes: function () {
            ...
            var footballGo = new game.Football();
            footballGo.x = 137;
            footballGo.y = 63;
            ...
            var footballOver = new game.Football();
            footballOver.x = 216;
            footballOver.y = 52;
