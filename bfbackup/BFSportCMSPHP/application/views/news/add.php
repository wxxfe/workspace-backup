                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <?php $this->load->view('common/linkMatch', array('current' => '')); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input maxlength="5" 
                                                       class="form-control" type="text" name="duration" value=""
                                                       placeholder="阅读时长"/>
                                            </div>
                            ...
                            <div class="box-footer">
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-success btn-lg" type="submit">下一步</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    $('#fileupload').fileupload({
        add: function (e, data) {
            ...
            if (result !== 10000) {
                ...
                $("#image-view").html('<img src="http://image.sports.baofeng.com/' + data.result.data.pid + '">').show();
    ...
    $('#fileupload-big').fileupload({
        add: function (e, data) {
            ...
            if (result !== 10000) {
                ...
                $("#image-view-big").html('<img src="http://image.sports.baofeng.com/' + data.result.data.pid + '">').show();
