                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 bvalidator-bs3form-msg">
                                                ...
                                                <select id="type-select" data-bvalidator-msg="请选择焦点图来源类型!" required name="type"
                                                        class="form-control">
                                                    <option value="">请选择</option>
                                                    <?php foreach ($types as $k => $v) { ?>
                                                        <option
                                                            value="<?= $k ?>" <?php if (isset($slide_info) && $slide_info && $slide_info['type'] == $k) {
                                                            echo "selected";
                                                        } ?>><?= $v ?></option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="col-sm-8 bvalidator-bs3form-msg">
                                                <div class="clearfix">
                                                    <input data-bvalidator="checkData,required"
                                                           ...
                                                           type="text" name="data"
                                                           value="<?php if (isset($slide_info) && $slide_info) {
                                                               if ($slide_info['type'] == 'html') {
                                                                   echo $slide_info['data'];
                                                               } else {
                                                                   echo $slide_info['ref_id'];
                                                               }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <span style="margin-left:30px;">建议尺寸795*302</span>
                                                <input id="poster" type="hidden" name="poster"
                                                       value="<?php if (isset($slide_info) && $slide_info['image']) {
                                                           echo $slide_info['image'];
                                                       } ?>"/>
                                                <div id="image-view"
                                                     style="padding: 10px 0; <?php if (isset($slide_info) && !$slide_info['image'] || !isset($id)) {
                                                         echo 'display: none;';
                                                     } ?>"><img style="max-height: 200px;"
                                                                src="<?php if (isset($slide_info) && $slide_info['image']) {
                                                                    echo getImageUrl($slide_info['image']);
                                                                } ?>"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="priority" placeholder=""
                                                       value="<?php if (isset($slide_info)) {
                                                           echo $slide_info['priority'];
                                                       } ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="checkbox">
                                                    <label><input type="checkbox" name="visible"
                                                                  value="1" <?php if (isset($slide_info) && $slide_info['visible']) {
