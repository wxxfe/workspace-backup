                        ...
                        <div class="box-body">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 30%;"><?= $module_title ?>标题</th>
...
<script>
    ...
    $('.editable').editable({
        ...
        validate: function (value) {
            ...
            var tJQ = $(this);
            //验证是否为有效URL，不是则提示
            if (tJQ.data('validation') == 'url' && !bValidator.validators.url(value)) {
                return bValidator.defaultOptions.messages.zh.url;
            }
            //验证是否超出最大字符数,超出则提示
        ...
        success: function (response, newValue) {
            var tJQ = $(this);
            //编辑成功后，如果是编辑url项目则更新预览链接
            if (tJQ.data('name') == 'url') {
                tJQ.parents('tr').find('.preview-btn').prop('href', newValue);
            }
        }
