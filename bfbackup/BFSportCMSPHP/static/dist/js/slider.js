...
(function(global) {
    ...
    Slider.prototype.runSlide = function(position,index){
        var p = position,_self = this;
        this.slider.stop().animate({'left' : p},this.opts.speed,function(){
