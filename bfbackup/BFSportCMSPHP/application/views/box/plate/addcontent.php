            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12" id="user-list">
                        <div class="box">
                            <div class="box-body">
                                <form class="form-horizontal" method="post" id="news-form" data-toggle="validator" active="" action="<?=base_url('/box/plate/addcontent/').$plateid?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="checkbox">
                                                        <label><input type="checkbox" name="visible" value="1"  <?php if (isset($contentinfo) && $contentinfo['visible'] ) { echo 'checked="checked"';} ?>></label>
                                                    </div>
                                                </div>
                                            </div>
                                          </div>
