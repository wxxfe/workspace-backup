...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"edit","1":"index"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports) {
	 ...
	 * 接口前缀
	 */
	var topicPrefix = 'http://api.board.sports.baofeng.com/api/v1/h5/board/thread/';
	...
	var COOKIES_KEY = exports.COOKIES_KEY = {
	    uid: 'bfuid',
	    uname: 'bfuname'
	};
	
	var URL_PARAM_NAME = exports.URL_PARAM_NAME = {
	...
	var Utils = exports.Utils = {
	     ...
	     * 获得Cookie项目值
	     */
	    docCookiesGetItem: function docCookiesGetItem(sKey) {
	        if (!sKey) {
	            return null;
	        }
	     ...
	     * 写入Cookie项目值
	     */
	    docCookiesSetItem: function docCookiesSetItem(sKey, sValue) {
	     ...
	     * 写入localStorage项目值
	     */
	    storageSetObj: function storageSetObj(key, obj) {
	     ...
	     * 根据用户ID获取用户头像
	     */
	    getUserAvatar: function getUserAvatar(uid) {
	    ...
	    getLiked: function getLiked() {
	        var liked = window.localStorage.getItem(STORAGE_KEY.liked);
	     ...
	     */
	    setLiked: function setLiked(id, add) {
	    ...
	    getInitDataCookie: function getInitDataCookie() {
	    ...
	    setInitDataCookie: function setInitDataCookie() {
	        var url = '';
	    ...
	    getInitDataStorage: function getInitDataStorage() {
	    ...
	    setInitDataStorage: function setInitDataStorage(clear) {
	        if (clear) {
	            window.localStorage.removeItem(STORAGE_KEY.editStatus);
	            window.localStorage.removeItem(STORAGE_KEY.canvasImg);
	            window.localStorage.removeItem(STORAGE_KEY.text);
	 ...
	 */
	var DataEdit = exports.DataEdit = {
	    maskImages: ['./build/img/mask/1.png', './build/img/mask/2.png', './build/img/mask/3.png', './build/img/mask/4.png', './build/img/mask/5.png'],
	    flagThumbnailImages: [{ img: './build/img/flags/1', title: '方形国旗' }, { img: './build/img/flags/2', title: '心星国旗' }, { img: './build/img/flags/3', title: '五角星' }, { img: './build/img/flags/4', title: '奥运五环' }, { img: './build/img/flags/5', title: '里约2016' }],
	    text: '',
	    canvasImg: '',
	    editStatus: 0
	};
	 ...
	 * 首页数据
	 */
	var DataIndex = exports.DataIndex = {
