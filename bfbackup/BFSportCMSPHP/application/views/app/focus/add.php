                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input data-bvalidator="checkPosition,required" data-bvalidator-msg="请输入1或3" class="form-control" type="text" name="position" placeholder="可填写1或3" value="<?php if (isset($info)){echo $info['position'];} ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script>
    ...
    bValidator.validators.checkData = function (value) {
        ...
        $.ajax({
            url: '<?=base_url("app/focus/checkContent");?>',
