    ...
    <div class="wrapper">
        <div class="content-wrapper" style="margin-left: 0;">
            <section class="content-header">
              <h1>视频列表<small>待编辑视频-编辑 </small></h1>
              <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-md-12" id="pending-video-list">
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" class="form-horizontal" method="post" id="pending_edit">
                            <!-- form start -->
                            <div class="box-body">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <div id="datetimepicker" class="input-append date">
                                                    <input data-format="yyyy-MM-dd hh:mm:ss" class="form-control" style="display: inline-block; width: 90%;" id="publish_tm" name="publish_tm" placeholder="" type="text">
                                                    <span class="add-on" style="display: inline-block; margin-left: 5px;">
                                                        <i data-time-icon="fa fa-clock-o" data-date-icon="fa fa-calendar"></i>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <input class="form-control" id="match_id" name="match_id" placeholder="若需关联比赛输入比赛ID" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" id="play_url" name="play_url" placeholder="如何是第三方视频需要填写" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="play_code" class="control-label col-md-2">播放代码</label>
                                            <div class="col-md-8">
                                                <textarea placeholder="用于App端播放" id="play_code" name="play_code" rows="3" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
...
$('#pending_edit').on('submit',function(){
    alert('ok');
});
