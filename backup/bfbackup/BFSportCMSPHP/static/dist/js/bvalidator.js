...
bValidator.validators = (function ($) {
    ...
    var validators = {
        ...
        minlen: function (value, minlength) {
            return (sizeof(value) >= parseInt(minlength))
        },

        maxlen: function (value, maxlength) {
            return (sizeof(value) <= parseInt(maxlength))
        },

        rangelen: function (value, minlength, maxlength) {
            return (sizeof(value) >= parseInt(minlength) && sizeof(value) <= parseInt(maxlength))
        },
