                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-flat btn-info btn-xs" role="button" href="<?=base_url('/ChannelVideo/block/'.$item['id'])?>"><i class="fa fa-edit"></i> 编辑资讯</a>
...
$.fn.editable.defaults.url = '<?=base_url("/ChannelVideo/updateField/tmpl_block")?>';
...
$("input[name='visible']").bootstrapSwitch({
    ...
    onSwitchChange: function (event, state) {
        $.ajax({
            method: "POST",
            url: '<?=base_url("/ChannelVideo/updateField/tmpl_block")?>',
...
$('.btn-remove').on('click',function(){
    ...
    swal(alertConfig,function(){
        $.get('<?=base_url("/ChannelVideo/remove")?>/tmpl_block/' + bid,function(d){
            if(d == 'success'){
